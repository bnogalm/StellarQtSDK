...
private slots:
    ...
    void testDeserialize() {
        ...
        QCOMPARE(tradesPage.getLinks().getNext().getHref(), QString("https://horizon.stellar.org/order_book/trades?order=asc&limit=10&cursor=43186647780560897-5"));
        QCOMPARE(tradesPage.getLinks().getPrev().getHref(), QString("https://horizon.stellar.org/order_book/trades?order=desc&limit=10&cursor=37129640086605825-1"));
        QCOMPARE(tradesPage.getLinks().getSelf().getHref(), QString("https://horizon.stellar.org/order_book/trades?order=asc&limit=10&cursor="));
        ...
        QCOMPARE(tradesPage.get(1).getSeller().getAccountId(), QString("GCI7ILB37OFVHLLSA74UCXZFCTPEBJOZK7YCNBI7DKH7D76U4CRJBL2A"));
    }
private:
