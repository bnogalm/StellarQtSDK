#ifndef LEDGERPAGEDESERIALIZERTEST_H
#define LEDGERPAGEDESERIALIZERTEST_H
#include <QObject>
#include <QtTest>
...
class LedgerPageDeserializerTest: public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void testDeserialize() {
        ...
        ledgersPage.loadFromJson(json);
        QCOMPARE(ledgersPage.get(0).getHash(), QString("f6fc9a29b5ecec90348e17a10a60e019c5cb8ea24f66a1063e92c13391b09b8d"));
        QCOMPARE(ledgersPage.get(0).getPagingToken(), QString("3862202096287744"));
        QCOMPARE(ledgersPage.get(9).getHash(), QString("8552b7d130e602ed068bcfec729b3056d0c8b94d77f06d91cd1ec8323c2d6177"));
        QCOMPARE(ledgersPage.getLinks().getNext().getHref(), QString("/ledgers?order=desc&limit=10&cursor=3862163441582080"));
        QCOMPARE(ledgersPage.getLinks().getPrev().getHref(), QString("/ledgers?order=asc&limit=10&cursor=3862202096287744"));
        QCOMPARE(ledgersPage.getLinks().getSelf().getHref(), QString("/ledgers?order=desc&limit=10&cursor="));
    }
...
ADD_TEST(LedgerPageDeserializerTest)
#endif // LEDGERPAGEDESERIALIZERTEST_H
