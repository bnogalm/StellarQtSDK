...
PathPaymentOperation::PathPaymentOperation(stellar::PathPaymentOp &op)
    :m_sendAsset(nullptr)
  ,m_destination(nullptr)
  ,m_destAsset(nullptr)
  ,m_op(op){
...
void PathPaymentOperation::fillOperationBody(stellar::Operation &op)
{
    ...
    new (&op.operationPathPayment) stellar::PathPaymentOp();
    op.operationPathPayment = m_op;
}

PathPaymentOperation *PathPaymentOperation::build(stellar::PathPaymentOp &op)
{
