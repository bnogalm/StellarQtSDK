#ifndef CREATEPASSIVEOFFEROPERATIONRESPONSE_H
#define CREATEPASSIVEOFFEROPERATIONRESPONSE_H
 ...
 */
class CreatePassiveOfferOperationResponse : public OperationResponse
{
    Q_OBJECT
...
public:
    CreatePassiveOfferOperationResponse(QNetworkReply *reply=nullptr);
    virtual ~CreatePassiveOfferOperationResponse();
...
Q_DECLARE_METATYPE(CreatePassiveOfferOperationResponse*)
#endif // CREATEPASSIVEOFFEROPERATIONRESPONSE_H
